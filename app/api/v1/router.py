...
from app.api.v1.battlemap import router as battlemap_router
...
api_router.include_router(diagnostic_router, prefix="/diagnostics", tags=["Diagnostics"])
api_router.include_router(battlemap_router, prefix="", tags=["Battle Maps (Phase 1.5)"])
